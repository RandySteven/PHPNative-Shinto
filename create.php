        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link text-red" aria-current="page" href="index.html">Home</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container mt-5">
        ...
        <form>
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="shrine_name" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
              <label for="shrine_name_japan" class="form-label">Shrine Name Japan</label>
              <input type="text" class="form-control" id="shrine_name_japan">
            </div>
            <div class="mb-3">
